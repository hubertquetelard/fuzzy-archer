...
[StdRESTful]
	...
	log_success = false
        ...
        enable = {{ Wunderground['enable']|default('false') }}
        station = {{ Wunderground['station']|default('WUXXXX') }}
        # To guard against parsing errors, put your password in quotes:
        password = {{ Wunderground['password']|default('WYPASS') }}
...
[StdReport]
    ...
    [[RSYNC]]
        ...
        path = /srv/stations/{{station_id|default('XXX000')}}/
        user = {{station_id_lowcase|default('xxx000')}}
